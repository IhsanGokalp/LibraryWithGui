...
public class ListBookPaneController {
    ...
    void returnTheBookPressed(ActionEvent event) throws IOException {
        ...
        String lastLine = lastLineGetter.getLastLine("/home/ihsang/Documents/Cs Kg/OOP/FinalLibrary/src/sample/Data/LoggedStudent.txt");
        String id = lastLine.substring(0,2);
        RemovingTheLine lineRemover = new LineRemover();
        lineRemover.removeTheLine(lastLine,"/home/ihsang/Documents/Cs Kg/OOP/FinalLibrary/src/sample/Data/LoggedStudent.txt");
    ...
    public void initialize() throws IOException {
        ...
        String bookToBeProcessed = lastLineGetter.getLastLine("/home/ihsang/Documents/Cs Kg/OOP/FinalLibrary/src/sample/Data/LoggedStudent.txt");
        ...
        String studentLoggedIn = lastLineGetter.getLastLine("/home/ihsang/Documents/Cs Kg/OOP/FinalLibrary/src/sample/Data/StudentsData.txt");
